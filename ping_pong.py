...
dados = [largura,altura,tela,x_player1,y_player1,x_player2,y_player2,x_bola,y_bola,velocidade_x_bola,velocidade_y_bola,pontos_p1,pontos_p2]

def Jogar(dados):
    largura,altura,tela,x_player1,y_player1,x_player2,y_player2,x_bola,y_bola,velocidade_x_bola,velocidade_y_bola,pontos_p1,pontos_p2 = dados
    ...
    while True:
        ...
        if x_bola <= x_player1 or x_bola >= 795: 
            velocidade_x_bola = 0
            velocidade_y_bola = 0
